...
export const Route = createFileRoute("/privacidad")({
  head: () => ({
    meta: [
      { title: "Política de Privacidad — Sofía Algorta Real Estate" },
      { name: "description", content: "Política de privacidad de Sofía Algorta Real Estate. Cómo recolectamos, usamos y protegemos sus datos." },
    ...
    <section className="pt-36 pb-20 bg-background">
      <div className="container-luxe max-w-3xl">
        ...
        <div className="mt-10 space-y-6 text-foreground/80 leading-relaxed">
          <p>En Sofía Algorta Real Estate respetamos su privacidad y nos comprometemos a proteger sus datos personales conforme a la legislación vigente en Uruguay.</p>
