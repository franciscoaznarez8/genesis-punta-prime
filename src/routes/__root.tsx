...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sofía Algorta Real Estate — Inmobiliaria y Administración en Punta del Este" },
      { name: "description", content: "Alquileres temporarios premium y administración integral de propiedades en Punta del Este, Uruguay. Atención personalizada y experiencias excepcionales." },
      { name: "author", content: "Sofía Algorta Real Estate" },
      { property: "og:site_name", content: "Sofía Algorta Real Estate" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Sofía Algorta Real Estate — Inmobiliaria y Administración en Punta del Este" },
      { name: "twitter:title", content: "Sofía Algorta Real Estate — Inmobiliaria y Administración en Punta del Este" },
