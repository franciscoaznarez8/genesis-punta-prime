...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Orígenes Propiedades — Inmobiliaria y Administración en Punta del Este" },
      ...
      { name: "author", content: "Orígenes Propiedades" },
      { property: "og:site_name", content: "Orígenes Propiedades" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Orígenes Propiedades — Inmobiliaria y Administración en Punta del Este" },
      { name: "twitter:title", content: "Orígenes Propiedades — Inmobiliaria y Administración en Punta del Este" },
